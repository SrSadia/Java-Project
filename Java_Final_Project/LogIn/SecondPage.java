...
public class SecondPage implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == trainButton) {
            //TRAIN BOOKING PAGE CLASS OBJECT WITH CONSTRACTOR             EXAMPLE         TicketBookingPage ticketBookingPage = new TicketBookingPage();
            //TRAIN BOOKING OAGE CLASS NAME        EXAMPLE            ticketBookingPage.setVisibility();
            frame.setVisible(false);
        }
        if (e.getSource() == shipButton) {
            //SHIP BOOKING PAGE CLASS OBJECT WITH CONSTRACTOR      EXAMPLE           TicketBookingPage ticketBookingPage = new TicketBookingPage();
            //ticketBookingPage.setVisibility();                    EXAMPLE
            frame.setVisible(false);                                
        }
        if (e.getSource() == busButton) {
            //BUS BOOKING PAGE CLASS OBJECT WITH CONSTRACTOR      EXAMPLE           TicketBookingPage ticketBookingPage = new TicketBookingPage();
            //ticketBookingPage.setVisibility();                    EXAMPLE
            frame.setVisible(false);
        }
